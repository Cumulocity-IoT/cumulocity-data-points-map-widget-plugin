...
@Component({
    selector: 'lib-gp-data-points-map-popup',
    templateUrl: './gp-data-points-map-popup.component.html',
    styleUrls: ['./gp-data-points-map-popup.component.css']
})

export class GPDataPointMapPopupComponent implements OnInit {
    @Input() uniqueId: any;
    @Input() editData: any;

    constructor(private router: Router,private commonService : GpDataPointsMapService ) {}
    popupDisplayList = [];
    dashboardId = null;
    tabGroupId = null;
    appId = null;
